...
# This will use the Decision Tree classifier to 
...
dt = DecisionTreeClassifier(max_features = None, random_state = 0)
...
#                  features__selection = [0, 1, 2, 3, 4, 5, 6, 7, 8])
#                  
#grid_search = GridSearchCV(pipeline, param_grid = param_grid, verbose = 1)
#grid_search.fit(features_train, labels_train)
#print(grid_search.best_estimator_)
#
#clf = Pipeline([('features', combined_features), ('dt', dt)])
